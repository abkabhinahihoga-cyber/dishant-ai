      ...
      <Card className="w-full max-w-md glass-card border-none shadow-2xl">
        <CardHeader className="space-y-1 text-center">
          <CardTitle className="text-2xl font-bold font-heading">
            {step === "details" ? "Create an account" : "Enter OTP Code"}
          </CardTitle>
          <CardDescription>
            {step === "details"
              ? "Join Dishant AI and start building your dream career"
            ...
            {step === "details" && (
              <>
                ...
                <form onSubmit={handleSendOtp} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full h-12" disabled={loading || !email || !fullName}>
