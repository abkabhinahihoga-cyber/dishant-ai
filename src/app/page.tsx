    ...
    <div className="flex flex-col min-h-screen overflow-x-hidden">
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden py-24 lg:py-32 flex flex-col items-center justify-center min-h-[90vh]">
          ...
          <div className="absolute top-1/4 left-1/4 -z-10 w-96 h-96 bg-primary/20 rounded-full blur-[100px] mix-blend-screen animate-blob"></div>
          <div className="absolute top-1/3 right-1/4 -z-10 w-80 h-80 bg-violet-500/20 rounded-full blur-[100px] mix-blend-screen animate-blob animation-delay-2000"></div>
          <div className="absolute bottom-1/4 left-1/2 -z-10 w-80 h-80 bg-blue-500/20 rounded-full blur-[100px] mix-blend-screen animate-blob animation-delay-4000"></div>
          ...
          <div className="container px-4 md:px-6 text-center animate-fade-up">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/signup" className="w-full sm:w-auto">
                <Button size="lg" className="rounded-full px-8 h-14 text-lg w-full shadow-xl shadow-primary/20 hover:scale-105 transition-all duration-300">
                  शुरू करो (Start for Free) <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Link href="/career-test" className="w-full sm:w-auto">
                <Button variant="outline" size="lg" className="rounded-full px-8 h-14 text-lg w-full bg-background/50 backdrop-blur-md border-border/50 hover:bg-muted transition-all duration-300">
                  Take Career Test
                </Button>
              </Link>
            </div>
        ...
        <section id="how-it-works" className="py-24 relative">
          <div className="container px-4 md:px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto relative">
              ...
              <div className="hidden md:block absolute top-12 left-1/6 right-1/6 h-0.5 bg-gradient-to-r from-primary/10 via-primary to-primary/10 -z-10"></div>
              
              <div className="flex flex-col items-center text-center relative group">
                <div className="w-24 h-24 rounded-2xl bg-background border border-primary/30 flex items-center justify-center text-3xl font-bold text-primary mb-6 shadow-lg shadow-primary/10 group-hover:scale-110 transition-transform duration-300 relative z-10">
                  1
                </div>
                <h3 className="text-2xl font-bold mb-3">Sign Up</h3>
                <p className="text-muted-foreground">Create your free account in seconds. अपना प्रोफाइल बनाओ.</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center relative group">
                ...
                <p className="text-muted-foreground">Answer simple questions to find your perfect fit. अपना टैलेंट पहचानो.</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center relative group">
                ...
                <h3 className="text-2xl font-bold mb-3">Get Roadmap</h3>
                <p className="text-muted-foreground">Follow a step-by-step plan to get hired. सफलता की तैयारी.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 relative overflow-hidden">
          ...
          <div className="container px-4 md:px-6 text-center">
            ...
            <Link href="/signup">
              <Button size="lg" className="rounded-full px-12 h-16 text-xl shadow-xl hover:scale-105 transition-all">
